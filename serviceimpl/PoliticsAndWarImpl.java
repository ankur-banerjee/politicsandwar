...
import com.github.src.game.pw.core.QueryExecutor;
import com.github.src.game.pw.domain.*;
import com.github.src.game.pw.enums.ResourceType;
import com.github.src.game.pw.queries.*;

/**
 * @author Ankur
 *
 */
public class PoliticsAndWarImpl implements IPoliticsAndWar {
	private QueryExecutor executor;
	private String apiKey;

	public PoliticsAndWarImpl(String apiKey, Boolean enableCache, Boolean testServerMode, int cacheSize, long cacheRetainTime) {
	    this.apiKey = apiKey;
	    if (enableCache)
